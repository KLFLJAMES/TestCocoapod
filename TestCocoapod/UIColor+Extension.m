...
static NSInteger randomImageIndex = 0;
...
{
    NSArray *colors = @[@"#fef4f4", @"#e9dfe5", @"#a6a5c4", @"#abced8", @"#d4dcd6", @"#7ebeab", @"#93b69c", @"#e0ebaf", @"#f8e58c", @"#f8f4e6"];
    if (randomImageIndex >= colors.count) {
        randomImageIndex = 0;
    }
    return [UIColor colorWithHexString:colors[randomImageIndex++]];;
}

+ (UIColor *) colorWithIndex:(NSInteger)index
{
    NSArray *colors = @[@"#4BAFA5", @"#44A28A", @"#3395A2", @"#2D7077", @"#0B6078",
                        @"#376181", @"#3D4565", @"#4566A7", @"#5981B1", @"#3F7CC3"];
    NSInteger idx = index % colors.count;
    return [UIColor colorWithHexString:colors[idx]];;
}
